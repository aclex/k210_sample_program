...
int lcd_init(uint32_t freq, int oct, uint16_t offset_w, uint16_t offset_h, uint16_t offset_w1, uint16_t offset_h1, int invert_color, uint16_t width, uint16_t height)
{
    uint8_t data = 0;
